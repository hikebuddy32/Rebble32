...
void hw_ambient_init(void)
{
    ...
    // esp32_power_request(ESP32_POWER_APB2, RCC_APB2Periph_ADC1);
    // esp32_power_request(ESP32_POWER_AHB1, RCC_AHB1Periph_GPIOA);
...
/*
    ...
    // esp32_power_release(ESP32_POWER_APB2, RCC_APB2Periph_ADC1);
    // esp32_power_release(ESP32_POWER_AHB1, RCC_AHB1Periph_GPIOA);
}
