/* snowy_common.c
 * Miscellaneous platform routines for Hikebuddy
 * RebbleOS
 *
...
const vibrate_t hw_vibrate_config = {
    .pin     = GPIO_Pin_4, // TODO modify the pin number appropriately
    .clock   = RCC_AHB1Periph_GPIOF,
};

// static const esp32_usart_config_t _usart3_config = {
//     .usart                = USART3,
...
void debug_write(const unsigned char *p, size_t len)
{
    ...
    // esp32_power_request(ESP32_POWER_APB1, RCC_APB1Periph_USART3);
    // esp32_power_request(ESP32_POWER_AHB1, RCC_AHB1Periph_GPIOC);
...
{
    // esp32_power_request(ESP32_POWER_APB1, RCC_APB1Periph_UART8);
    // esp32_power_request(ESP32_POWER_AHB1, RCC_AHB1Periph_GPIOE);
}

void log_clock_disable(void)
{
    // esp32_power_release(ESP32_POWER_APB1, RCC_APB1Periph_UART8);
    // esp32_power_release(ESP32_POWER_AHB1, RCC_AHB1Periph_GPIOE);
}
...
#include "hikebuddy_backlight_platform.h"

hikebuddy_backlight_config_t platform_backlight = {
  .pin = GPIO_Pin_14,
  .tim = TIM12,
